...
from .models import Competition, Match, Opponent
...
class CompetitionTestCase(TestCase):
    def test_string(self):
        competition = Competition.objects.create(title="FAI Cup")
        self.assertEqual(str(competition), "FAI Cup")


class MatchTestCase(TestCase):
    def setUp(self):
        self.competition = Competition.objects.create(title="FAI Cup")
        self.opponents = Opponent.objects.create(name="Finn Harps")
        self.squad = Squad.objects.create(name="First Team")
